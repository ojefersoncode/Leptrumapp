...
export function SearchBar({ onFilterChange }: Props) {
  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between md:gap-4 items-center w-full">
      ...
      />
      <div className="flex max-md:pt-4 max-md:px-7 justify-center items-center md:space-x-7 gap-5">
        <Select onValueChange={(value) => handleChange('category', value)}>
          <SelectTrigger className="max-md:w-[170px] md:w-[130px] px-3">
        ...
        <Select onValueChange={(value) => handleChange('gender', value)}>
          <SelectTrigger className="max-md:w-[170px] md:w-[120px] px-3">
