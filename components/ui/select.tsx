...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-7 items-center justify-between rounded-md border border-zinc-200 px-3 py-2 text-sm ring-offset-white data-[placeholder]:text-zinc-900 focus:outline-none focus:ring-1 focus:ring-zinc-50 focus:ring-offset-2 [&>span]:line-clamp-1 dark:border-zinc-800 bg-zinc-100 dark:ring-offset-zinc-50 dark:data-[placeholder]:text-zinc-900 text-slate-800',
      className
    )}
    {...props}
  >
