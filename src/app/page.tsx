  ...
  return (
    <>
      <div className="min-h-screen w-full bg-indigo-950 text-white flex flex-col items-center justify-center px-6 text-center">
        ...
        <main className="flex-1 flex flex-col max-md:mt-10 mt-20 items-center justify-center">
          ...
          <div className="flex items-center max-sm:justify-start justify-center mt-6 gap-4">
            <ShimmerButton 
