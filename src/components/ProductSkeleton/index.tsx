...
const ProductSkeleton = () => (
  <div className="flex w-full flex-col bg-white space-y-3 m-2">
    <Skeleton className="h-[200px] w-[290px] max-md:w-[170px] rounded-xl" />
    <div className="mx-4">
      <div className="space-y-3">
        <div className="flex gap-2">
          <Skeleton className="h-3 w-[20px] max-md:w-[20px]" />
          <Skeleton className="h-3 w-[120px] max-md:w-[90px] " />
        </div>
